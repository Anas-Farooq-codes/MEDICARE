...
<div className="relative h-[750px] w-full md:h-[900px] lg:h-[592px] 3xl:max-w-[1200px]">
  <div className="w-full py-16 md:w-[500px] md:py-24">
    <motion.h2
    ...
    className="text-4xl font-bold leading-tight tracking-[-0.96px] text-[#fcfcfd] md:text-[48px] md:leading-[60px]">
      Different Cards For Different Payment
    </motion.h2>
    ...
    className="mt-6 text-base font-medium leading-6 text-[#eef5ff] md:text-[20px] md:leading-[30px]">
We revolutionize the way you make payments, offering a convenient, and contactless way to complete transitions 
    </motion.p>
...
<img src={arrow} alt="arrow" className="group-hover:invert z-10" />
  ...
  className="md:-bottom-[50px] lg:righ t-[149px] absolute -bottom-[0px] left-0 right-0 z-30 hidden h-[400px] w-full flex-col justify-start -space-y-[140px] overflow-clip sm:h-[500px] sm:-space-y-[290px] md:left-auto md:right-[50px] md:h-[500px] md:w-auto md:-space-y-[320px] lg:right-0 lg:h-[650px] lg:-space-y-[290px] xl:flex xl:-space-y-0"
  >
  <motion.img
...
<motion.div
  ...
  className="md:-bottom-[-50px] lg:righ t-[149px] absolute -bottom-[0px] left-0 right-0 z-30 flex h-[400px] w-full flex-col justify-start -space-y-[140px] overflow-clip sm:h-[500px] sm:space-y-[290px] md:left-auto md:right-[50px] md:h-[500px] md:w-auto md:space-y-[320px] lg:right-0 lg:h-[650px] lg:space-y-[290px] xl:hidden xl:space-y-0"
>
  <img src={cardOne} alt="" className="z-[12]" />
  <img src={cardThree} alt="" className="rotate -[-30deg] z-[11]" />
<img src={cardFour} alt="" className="z-[10]" />
