    ...
    <section id="features" className="flex w-full flex-col items-center justify-center gap-6 border-t border-[#e2e4e9] px-6 py-16 md:px-10 xl:px-[159px]">
      <div className="flex w-full flex-col items-start justify-between gap-8 xl:flex-row xl:items-end 3xl:max-w-[1200px]">
        <div className="flex flex-col">
          ...
          We combine advanced medical technology, skilled professionals, and patient-centered solutions to deliver comprehensive healthcare services with the highest standards of care and efficiency. Our goal is to provide seamless, accessible healthcare tailored to your needs.
          </motion.p>
        </div>
      ...
      <div className="relative mt-5 flex w-full flex-col items-center justify-between gap-8 md:mt-0 md:flex-row xl:gap-0 3xl:max-w-[1200px]">
        <motion.div
          ...
          <div className="w-full px-12 pb-8 pt-12">
            ...
            <p className="text-base font-medium leading-6 tracking-[-0.16px] text-[#2f2b43]/60">
            We offer telemedicine services for easy, convenient access to expert consultations from the comfort of your home.
            </p>
          </div>
        ...
        <motion.div
          ...
          <div className="w-full px-12 pb-8 pt-12">
            ...
            <p className="text-base font-medium leading-6 tracking-[-0.16px] text-[#2f2b43]/60">
              We combine traditional healthcare practices with innovative technology, ensuring a seamless and efficient healthcare experience.
            </p>
          </div>
        ...
        <motion.div
          ...
          <div className="w-full px-12 pb-8 pt-12">
            ...
            <p className="mt-4 w-[75%] text-base font-medium leading-6 tracking-[-0.16px] text-[#2f2b43]/60">
              Our dental services offer advanced treatments and preventive care to ensure your oral health remains in top condition.
            </p>
          </div>
        ...
        <motion.div
          ...
          <div className="w-full px-12 pb-8 pt-12">
            ...
            <p className="mt-4 text-base font-medium leading-6 tracking-[-0.16px] text-[#2f2b43]/60">
              Our healthcare professionals are dedicated to offering tailored services that address your unique health requirements.
            </p>
          </div>
